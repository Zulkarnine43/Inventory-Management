                                    ...
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="col-md-12 text-center">
                                              ...
                                              <h2>Rainbow Digital</h2>
                                                    ...
                                                    <p>01714303381(manager),01732647391</p>
                                                    <p>Website:www.rainbowdigitalbd.com,E-mail:rainbowdigitalbd@gmail.com</p>
                                        ...
                                        <div class="row" style="border-radius: 0px;"><br>
                                            ...
                                            <div class="col-md-3 ">
                                                ...
                                                <hr>
                                            <h4 class="text-right">Total: {{ $order->sub_total }}</h4>
                                             <h4 class="text-right">Due: {{ $order->due }}</h4> 
                                             <h4 class="text-right">Discount: {{ $order->discount }}</h4>
