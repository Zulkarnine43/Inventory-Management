...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Feb 13, 2022 at 06:10 PM
...
INSERT INTO `products` (`id`, `product_name`, `cat_id`, `product_unit`, `sup_id`, `product_code`, `product_garage`, `product_route`, `product_image`, `buy_date`, `expire_date`, `buying_price`, `selling_price`, `created_at`, `updated_at`) VALUES
(1, 'card', 1, 0, 1, NULL, NULL, NULL, 'public/Products/dUbAm.jpg', NULL, NULL, NULL, '9.1', NULL, NULL),
(2, 'book', 1, 0, 1, NULL, NULL, NULL, 'public/Products/EOo5T.jpg', NULL, NULL, NULL, '60', NULL, NULL),
(3, 'fatun', 1, 0, 1, NULL, NULL, NULL, 'public/Products/SYcgh.jpg', NULL, NULL, NULL, '5', NULL, NULL),
(4, 'bannerjjhkb', 1, 0, 1, 'iu0iui', 'u09u9', 'oioi', 'public/Products/yUyTV.jpg', '2020-02-21', '2020-02-21', '100', '6', NULL, NULL),
(5, 'banner', 1, 0, 1, NULL, NULL, NULL, 'public/Products/ENZBd.jpg', NULL, NULL, NULL, '200', NULL, NULL),
(6, 'banner', 1, 0, 1, NULL, NULL, NULL, 'public/Products/uDu13.jpg', NULL, NULL, NULL, '6.6', NULL, NULL),
(7, 'banner', 1, 0, 1, NULL, NULL, NULL, 'public/Products/QAPZC.jpg', NULL, NULL, NULL, '5', NULL, NULL),
(8, 'Mobail', 1, 0, 1, NULL, NULL, NULL, 'public/Products/1588I.jpg', NULL, NULL, NULL, '5', NULL, NULL),
(9, 'Mobail', 1, 0, 1, NULL, NULL, NULL, 'public/Products/yMvsI.jpg', NULL, NULL, NULL, '5', NULL, NULL),
(10, 'banner', 3, 0, 1, '12344', '1', '1', 'public/Products/N2W5N.jpg', '111111-11-11', '11111-11-11', '1111', '1111', NULL, NULL),
(11, 'english learning', 3, 50, 1, 'dgdsfg', '34', '4545fgdgvdf', 'public/Products/6U0GO.jpg', '2022-02-18', '2022-02-23', '100', '120', NULL, NULL);
...
CREATE TABLE IF NOT EXISTS `purchases` (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `purchase_name` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cat_id` int(11) NOT NULL,
  `purchase_unit` int(11) NOT NULL,
  `sup_id` int(11) NOT NULL,
  `purchase_code` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `purchase_garage` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `purchase_route` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
